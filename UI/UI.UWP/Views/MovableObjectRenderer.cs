...
[assembly: ExportRenderer(typeof(MovableObject), typeof(MovableObjectRenderer))]
namespace SINTEF.AutoActive.UI.UWP.Views
{
    internal class MovableObjectRenderer : ViewRenderer<MovableObject, Panel>, IDropCollector
    {
        ...
        public MovableObjectRenderer() : base()
        {

        }

        protected override void OnElementChanged(ElementChangedEventArgs<MovableObject> e)
        {
            base.OnElementChanged(e);

            if (e.NewElement is MovableObject movableObject)
        ...
        private void ControlOnManipulationCompleted(object sender, ManipulationCompletedRoutedEventArgs e)
        {
            ...
            foreach (var element in elements)
            {
                ...
                if (_movableObject is TreeButton treeButton)
                {
                    dropCollector.ObjectDroppedOn(treeButton.CreateNewView());
                    return;
                }
                dropCollector.ObjectDroppedOn(_movableObject);
        ...
        public void ObjectDroppedOn(IDraggable item)
        {
            ...
            _movableObject.ObjectDroppedOn(item);
        }
    }
}
